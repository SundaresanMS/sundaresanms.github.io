...
1
        document.getElementById('surveyElement').innerHTML =  "<br><br><div id='modified_card' style='display:inline-block;font-weight: 700;letter-spacing: 2px;font-size: 2.25rem;border-radius: 25px;width:100%;text-align: center;'><br><br><h3>  Recommended System ="+(String(possible_system_size))+"KW.  </h3><br><br></div>";
